...
```shell
go run github.com/3dsinteractive/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-chat-example](https://github.com/3dsinteractive/langchaingo/blob/main/examples/mistral-chat-example/mistral_chat_example.go)).
