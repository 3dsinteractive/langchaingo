...
import (
	...
	"github.com/3dsinteractive/langchaingo/llms/googleai"
	"github.com/3dsinteractive/langchaingo/llms/googleai/vertex"
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://github.com/3dsinteractive/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
