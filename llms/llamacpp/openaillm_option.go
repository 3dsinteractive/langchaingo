...
const (
	APITypeOpenAI  APIType = APIType(llamacppclient.APITypeOpenAI)
	APITypeAzure           = APIType(llamacppclient.APITypeAzure)
	APITypeAzureAD         = APIType(llamacppclient.APITypeAzureAD)
)
...
type options struct {
	...
	organization string
	apiType      APIType
	httpClient   llamacppclient.Doer
